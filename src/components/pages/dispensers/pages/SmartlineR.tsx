      ...
      <div className="dispenser-page-container">
        ...
        <SummaryViewSection>
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_R_SCREEN}
          />
          <SummaryContent
            headerText="Design"
            ...
            imagePath={IMAGES.SMARTLINE_R_DESIGN}
          />
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_R_TERMINAL}
          />
          <Button text="Order Now" type="primary" fullwidth={true} />
        </SummaryViewSection>
        <FeaturesHero heroImagePath={IMAGES.SMARTLINE_R}>
          <FeaturesContent subHeaderText="Smartline R" headerText="Features">
            <p>
