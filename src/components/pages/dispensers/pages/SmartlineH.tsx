      ...
      <div className="dispenser-page-container">
        ...
        <SummaryViewSection>
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_H_SCREEN}
          />
          <SummaryContent
            headerText="Design"
            ...
            imagePath={IMAGES.SMARTLINE_H_DESIGN}
          />
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_H_TERMINAL}
          />
          <Button text="Order Now" type="primary" fullwidth={true} />
        </SummaryViewSection>
        <FeaturesHero heroImagePath={IMAGES.SMARTLINE_H}>
          <FeaturesContent subHeaderText="Smartline H" headerText="Features">
            <p>
              Designed, developed and tested by Mepsan R&D engineers. Smartline
              H is one of the most common dispensers out of the Smartline
              series.
            </p>
            <ul>
