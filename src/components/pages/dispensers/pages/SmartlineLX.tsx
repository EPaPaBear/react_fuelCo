      ...
      <div className="dispenser-page-container">
        ...
        <SummaryViewSection>
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_LX_SCREEN}
          />
          <SummaryContent
            headerText="Design"
            ...
            imagePath={IMAGES.SMARTLINE_LX_DESIGN}
          />
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_LX_TERMINAL}
          />
          <Button text="Order Now" type="primary" fullwidth={true} />
        </SummaryViewSection>
        <FeaturesHero heroImagePath={IMAGES.SMARTLINE_LX}>
          <FeaturesContent subHeaderText="Smartline LX" headerText="Features">
            <p>
              Designed, developed and tested by Mepsan R&D engineers. Smartline
              LX is one of the most common dispensers out of the Smartline
              series.
            </p>
            <ul>
