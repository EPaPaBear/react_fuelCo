      ...
      <div className="dispenser-page-container">
        ...
        <SummaryViewSection threeDModel={scene}>
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_C_SCREEN}
          />
          <SummaryContent
            headerText="Design"
            ...
            imagePath={IMAGES.SMARTLINE_C_DESIGN}
          />
          <SummaryContent
            ...
            imagePath={IMAGES.SMARTLINE_C_TERMINAL}
          />
          <Button text="Order Now" type="primary" fullwidth={true} />
        </SummaryViewSection>
        <FeaturesHero heroImagePath={IMAGES.SMARTLINE_C}>
          <FeaturesContent subHeaderText="Smartline C" headerText="Features">
            <p>
              Designed, developed and tested by Mepsan R&D engineers. Smartline
              C is one of the most common dispensers out of the Smartline
              series.
            </p>
            <ul>
